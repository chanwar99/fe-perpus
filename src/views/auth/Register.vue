            ...
            <form @submit.prevent="handleSubmit">
                <div class="space-y-4">
                    <label class="block">
                        ...
                        <input v-model="userData.name" type="text" class="input input-bordered w-full mt-1" />
                    ...
                    <label class="block">
                        <span class="text-gray-400">Password Confirmation</span>
                        <input v-model="userData.password_confirmation" type="password"
